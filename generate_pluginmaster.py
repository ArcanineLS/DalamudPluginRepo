...
# Owner of the plugin repositories whose release download counts are aggregated.
REPO_OWNER = 'ArcanineLS'
...
def add_extra_fields(manifests):
    for manifest in manifests:
        ...
        manifest['DownloadCount'] = get_release_download_count(REPO_OWNER, manifest["InternalName"])
